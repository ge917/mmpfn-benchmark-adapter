...
!!! example
    ...
    from mmpfn.models.mmpfn import TabPFNRegressor
...
from mmpfn.models.mmpfn.base import (
    create_inference_engine,
    determine_precision,
    initialize_mmpfn_model,
)
...
from mmpfn.models.mmpfn.model.preprocessing import (
    ReshapeFeatureDistributionsStep,
)
from mmpfn.models.mmpfn.preprocessing import (
    EnsembleConfig,
    RegressorEnsembleConfig,
    default_regressor_preprocessor_configs,
)
from mmpfn.models.mmpfn.utils import (
    _fix_dtypes,
...
if TYPE_CHECKING:
    ...
    from mmpfn.models.mmpfn.inference import (
        InferenceEngine,
    )
...
class MMPFNRegressor(RegressorMixin, BaseEstimator):
    """MMPFNRegressor class."""
    ...
    def fit(self, X: XType, image: np.ndarray, y: YType) -> Self:
        """Fit the model.
        ...
        self.model_, self.config_, self.bardist_ = initialize_mmpfn_model(
