...
- A registry for 11 VT-Bench discriminative datasets, 10 non-duplicate MulTaBench image--tabular datasets with `Text=0`, and three original-MMPFN image--tabular datasets: CBIS-DDSM (Calc), CBIS-DDSM (Mass), and PetFinder-I (T+I).
...
mmpfn/prepare_mmpfn_image_benchmarks.py  Original-MMPFN CBIS/PetFinder preparation
